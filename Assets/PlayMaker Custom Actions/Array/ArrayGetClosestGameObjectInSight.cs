...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Return the closest GameObject within an array from a transform or position which does not have a collider between itself and another GameObject")]
