...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class RayCast2d : FsmStateActionAdvanced
	{
		[ActionSection("Setup")]
		...
		[Tooltip("Set how often to cast a ray. ALWAYS LEAVE 'EveryFrame' option true if you repeat more than once). 0 = once, don't repeat; 1 = everyFrame; 2 = every other frame... \nSince raycasts can get expensive use the highest repeat interval you can get away with.")]
